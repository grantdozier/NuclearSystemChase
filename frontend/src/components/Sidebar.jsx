  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-header">
        <h1>Chase Group</h1>
        <span className="sidebar-subtitle">Construction CRM</span>
      </div>
      <nav className="sidebar-nav">
        {navItems.map(({ to, label }) => (
          ...
          >
            <span className="nav-icon">{iconSvgs[to]}</span>
            {label}
          </NavLink>
        ))}
      </nav>
      <div className="sidebar-footer">
        <div className="sidebar-footer-text">Chase Group Construction</div>
